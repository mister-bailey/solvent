...
def run_md(molecule, solvent_name="chloroform", num=100, confId=0):
    """
    ...
    Args:
        ...
        num (int): number of solvent molecules
    ...
    print("BOX VECTORS")
    print(off_topology.box_vectors)
...
if __name__=="__main__":
    ...
    if len(sys.argv) > 2:
        ...
        print("Using chloroform as default solvent...")
        run_md(molecule)
